...
List<planetinfo> plants = [
  planetinfo(position: 1,
      ...
      images: [
        "https://i.pinimg.com/originals/12/9b/c2/129bc2f7a2f846fd071aaba2675d5c13.jpg",
        "https://solarsystem.nasa.gov/system/downloadable_items/1073_PIA16853.jpg",
  ...
  planetinfo(position: 2,
      ...
      images: [
        ...
        "https://swordstoday.ie/wp-content/uploads/2021/10/Venus-never-had-an-ocean-on-its-surface.jpg",
        'https://image.shutterstock.com/image-photo/solar-system-venus-second-planet-600w-515581927.jpg'
      ]),
  planetinfo(position: 3,
      name: 'Earth',
      ...
      images: [
        ...
        "https://thumbor.forbes.com/thumbor/fit-in/1200x0/filters%3Aformat%28jpg%29/https%3A%2F%2Fspecials-images.forbesimg.com%2Fimageserve%2F5fe74d45a9c2a2d204db2948%2F0x0.jpg",
        "https://carbontracker.org/wp-content/uploads/2020/12/Burning-Planet-Earth.png",
        'https://image.shutterstock.com/image-photo/3d-render-planet-earth-viewed-600w-1069251782.jpg'
      ]),
  planetinfo(position: 4,
      name: 'Mars',
  ...
  planetinfo(position: 5,
      ...
      images: [
        "https://cdn.abcotvs.com/dip/images/10959546_081821-cc-accuwx-jupiter-opposition-img.jpg?w=1600",
        "https://dynaimage.cdn.cnn.com/cnn/c_fill,g_auto,w_1200,h_675,ar_16:9/https%3A%2F%2Fcdn.cnn.com%2Fcnnnext%2Fdam%2Fassets%2F210304163540-jupiter-mercury-conjunction-2021.jpg"

      ]),
  planetinfo(position: 6,
      name: 'Saturn',
      ...
      images: [
        "https://cdn.kalingatv.com/wp-content/uploads/2020/04/Saturns-image-The-Jakarta-Post.jpg",
        "https://solarsystem.nasa.gov/system/stellar_items/image_files/38_saturn_1600x900.jpg",
        "https://m.media-amazon.com/images/M/MV5BZjA1NTVhYjAtZjFkOC00NmFjLWJlYzEtMjAwYzE5YWRjZGQyXkEyXkFqcGdeQXVyMTYzMTY1MjQ@._V1_.jpg"
      ]),
  planetinfo(position: 7,
      name: 'Uranus',
      ...
      images: [
        "https://images.theconversation.com/files/73449/original/image-20150302-5236-19u573n.jpg?ixlib=rb-1.1.0&q=45&auto=format&w=1000&fit=clip",
        "https://researchmatters.in/sites/default/files/styles/amp_metadata_content_image_min_696px_wide/public/jupiter.png?itok=3w3RxenG"
      ]),
  planetinfo(position: 8,
      name: 'Neptune',
      ...
      images: [
        ...
        "https://cdn.cdnparenting.com/articles/2019/03/30155119/523870474-H.jpg"
      ]),
